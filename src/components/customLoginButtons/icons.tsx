const LOGIN_BUTTON_ICON_SIZE = 28;

export function GoogleIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={LOGIN_BUTTON_ICON_SIZE} height={LOGIN_BUTTON_ICON_SIZE}>
            <linearGradient
...
export function FacebookIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={LOGIN_BUTTON_ICON_SIZE} height={LOGIN_BUTTON_ICON_SIZE} viewBox="0 0 90 90">
            <g>
                <path
